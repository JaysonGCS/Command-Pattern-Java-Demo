...
@Service
public class KarateInvokerSvc implements IInvokerService {
    private static final Logger LOGGER = LoggerFactory.getLogger(KarateInvokerSvc.class);

    private final Map<String, ICommandService> cmdServiceMap = new HashMap<>();

    @Override
    public void fight() {
        LOGGER.info("Karate Fight");
